  ...
  return (
    <Main>
      <div class="grid lg:grid-cols-2 lg:gap-48">
        ...
        <div className="">
          <div className="bg-gray-100 flex flex-col justify-center mb-5">
            <div className="relative py-1 sm:max-w-sm sm:mx-auto">
              <div className="rounded border border-gray-300 px-6 py-1 my-1">
                ...
                <div className="flex text-gray-700 mt-3">
                  <a
                    className="flex items-center mr-3 text-gray-500 hover:text-blue-600 transition hover:underline"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <svg
                  ...
                  >
                    ...
                    <span className="text-sm">5,434</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="text-sm">23,519</span>
                  </a>
                </div>
              </div>
            </div>
